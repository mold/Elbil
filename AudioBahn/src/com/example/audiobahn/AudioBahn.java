...
public class AudioBahn implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public AudioBahn(Context context) {
		this.context = context;
		readyListeners = new ArrayList<AudioBahn.ReadyListener>();
