...
public class GoogleAPIQueries {
	 ...
	 * 
	 * @param from The start position, given in human readable form.
	 * @param to The end position, given in human readable form.
	 * @return The APIRequestTask associated with this call. Use the .get() method
	 * to retrieve the result.
	 */
	public static APIRequestTask requestDirections(String from,
			String to) {
	 ...
	 * @return
	 */
	public static APIRequestTask requestSampledElevation(String points, int samples) {
