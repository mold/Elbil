...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			String res = GoogleAPIQueries.requestDirections(
					"Chicago,IL", "Los Angeles,CA").get();
			
			//DirectionsResult directionsResult = gson.fromJson(res, DirectionsResult.class);
			JsonParser fact = APIRequest.JSON_FACTORY.createJsonParser(res);
			DirectionsResult directionsResult = fact.parse(DirectionsResult.class);
